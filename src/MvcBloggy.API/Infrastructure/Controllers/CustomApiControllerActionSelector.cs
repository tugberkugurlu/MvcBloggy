...
namespace MvcBloggy.API.Infrastructure.Controllers {
    ...
    /// We optimize for the case where we have an <see cref="CustomApiControllerActionSelector"/> instance per <see cref="HttpControllerDescriptor"/>
    ...
    /// <see cref="CustomApiControllerActionSelector"/> as well. In the latter case the lookup is slightly slower because it goes through
    ...
    public class CustomApiControllerActionSelector : IHttpActionSelector {
        ...
        private class ActionSelectorCacheItem {
            ...
            public ActionSelectorCacheItem(HttpControllerDescriptor controllerDescriptor) {
                ...
                for (int i = 0; i < validMethods.Length; i++) {
                    ...
                    if (method.IsDefined(typeof(UriParameterAttribute))) {

                        string[] customDefinedParams = method.GetCustomAttribute<UriParameterAttribute>().Parameters;
            ...
            public HttpActionDescriptor SelectAction(HttpControllerContext controllerContext) {
                ...
                if (useActionName) {
                    ...
                    if (actionsFoundByName.Length == 0) { 
                        ...
                        // TODO: This doesn't have the messageDetail as that overload of CreateErrorResponse method was internal
                        // Make it work.
